...
class EkfAttitude(Attitude):
    ...
    def accelemeterUpdate(self,accel:list,mag:list):
        h_k = self.obsMatrix(self._Xs[0,0],self._Xs[1,0],self._Xs[2,0],self._Xs[3,0]);
        ...
        pitch_predit,roll_predict,yaw_predict = Quat2Euler(self._Xs[0,0],self._Xs[1,0],self._Xs[2,0],self._Xs[3,0]);
    ...
    def calculateAtt(self):        
        ...
        for imu in imu_data:
            ...
            pitch_hat,roll_hat,yaw_hat = Quat2Euler(self._Xs[0,0],self._Xs[1,0],self._Xs[2,0],self._Xs[3,0]);
